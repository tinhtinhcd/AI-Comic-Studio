...
const FinalComicView: React.FC<FinalComicViewProps> = ({ project }) => {
  ...
  return (
    <div className="fixed right-0 top-0 bottom-0 w-full sm:w-80 md:w-96 xl:w-[26rem] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 shadow-[0_0_40px_rgba(0,0,0,0.05)] dark:shadow-none overflow-hidden flex flex-col z-20 transition-all duration-300">
        <style>{`
          @keyframes kenburns {
        ...
        <div className="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex justify-between items-center z-10 shrink-0">
