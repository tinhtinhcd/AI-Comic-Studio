...
const AgentTodoList: React.FC<AgentTodoListProps> = ({ role, project, updateProject, t, onClose }) => {
    ...
    return (
        <>
            ...
            <div className="fixed inset-x-0 bottom-0 top-auto md:top-20 md:right-6 md:left-auto md:bottom-auto md:w-80 bg-white dark:bg-gray-800 rounded-t-2xl md:rounded-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.1)] md:shadow-2xl border-t md:border border-gray-200 dark:border-gray-700 flex flex-col z-50 animate-in slide-in-from-bottom-full md:slide-in-from-right-4 ring-1 ring-gray-900/5 dark:ring-black/20 max-h-[85vh] md:max-h-[500px]">
                {/* Header */}
