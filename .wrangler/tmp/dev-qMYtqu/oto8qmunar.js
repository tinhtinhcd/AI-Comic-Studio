...
// .wrangler/tmp/bundle-DiiukU/checked-fetch.js
...
// .wrangler/tmp/pages-0eDdtk/functionsWorker-0.8814737958226821.mjs
...
var oo = /* @__PURE__ */ __name2((r, e, t) => e in r ? Ce(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t, "oo");
...
var An = /* @__PURE__ */ __name2((r, e, t, n) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of no(e)) !so.call(r, i) && i !== t && Ce(r, i, { get: /* @__PURE__ */ __name2(() => e[i], "get"), enumerable: !(n = ro(e, i)) || n.enumerable });
  return r;
}, "An");
var Te = /* @__PURE__ */ __name2((r, e, t) => (t = r != null ? to(io(r)) : {}, An(e || !r || !r.__esModule ? Ce(t, "default", {
  value: r,
  enumerable: true
}) : t, r)), "Te");
var N = /* @__PURE__ */ __name2((r) => An(Ce({}, "__esModule", { value: true }), r), "N");
var _ = /* @__PURE__ */ __name2((r, e, t) => oo(r, typeof e != "symbol" ? e + "" : e, t), "_");
var In = I((nt) => {
  "use strict";
  p();
  nt.byteLength = uo;
...
var je = {};
ie(je, { default: /* @__PURE__ */ __name2(() => $o, "default") });
var $o;
var He = z(() => {
  "use strict";
  p();
...
var qt = {};
ie(qt, { createHash: /* @__PURE__ */ __name2(() => Ko, "createHash"), createHmac: /* @__PURE__ */ __name2(() => zo, "createHmac"), randomBytes: /* @__PURE__ */ __name2(() => Vo, "randomBytes") });
function Vo(r) {
...
var tr = {};
ie(tr, { join: /* @__PURE__ */ __name2(() => ou, "join") });
function ou(...r) {
  return r.join("/");
}
__name(ou, "ou");
...
var nr = {};
ie(nr, { stat: /* @__PURE__ */ __name2(() => au, "stat") });
function au(r, e) {
...
var sr = {};
ie(sr, { default: /* @__PURE__ */ __name2(() => uu, "default") });
var uu;
var or = z(() => {
  "use strict";
  p();
...
var Qi = {};
ie(Qi, { StringDecoder: /* @__PURE__ */ __name2(() => ar, "StringDecoder") });
var ur;
var ar;
var Wi = z(() => {
  "use strict";
...
var Xi = {};
ie(Xi, { default: /* @__PURE__ */ __name2(() => Tu, "default") });
var Tu;
var es = z(() => {
  "use strict";
  p();
...
var ts = {};
ie(ts, { parse: /* @__PURE__ */ __name2(() => fr, "parse") });
...
var ys = {};
ie(ys, { Socket: /* @__PURE__ */ __name2(() => _e, "Socket"), isIP: /* @__PURE__ */ __name2(() => Fu, "isIP") });
function Fu(r) {
  return 0;
}
__name(Fu, "Fu");
...
var Es = {};
ie(Es, { connect: /* @__PURE__ */ __name2(() => lc, "connect") });
...
var Ds = {};
ie(Ds, { default: /* @__PURE__ */ __name2(() => Cc, "default") });
var Cc;
var ks = z(() => {
  "use strict";
  p();
...
var fetchImageAsDataUrl = /* @__PURE__ */ __name2(async (url) => {
...
var extractImageFromJson = /* @__PURE__ */ __name2((data) => {
...
var handleImageGenerate = /* @__PURE__ */ __name2(async (context) => {
  const body = await context.request.json();
  const provider = body.provider;
  const prompt = body.prompt;
  const width = body.width ? Number(body.width) : void 0;
  const height = body.height ? Number(body.height) : void 0;
  const referenceImage = body.referenceImage;
  const apiKeyOverride = body.apiKey;
  if (!provider || !prompt) {
  ...
  if (provider === "OPENAI") {
    ...
    const size = width && height ? width >= height ? "1536x1024" : "1024x1536" : "1024x1024";
...
var onRequest = /* @__PURE__ */ __name2(async (context) => {
  ...
  const ensureSchema = /* @__PURE__ */ __name2(async () => {
    try {
  ...
  try {
    ...
    if (path === "admin/stats" && method === "GET") {
      try {
        ...
        const stats = {
          ...
          revenue: parseInt(userCountRes.rows[0].count) * 10,
          // Mock revenue metric based on users
          flaggedContent: 0
        };
    ...
    if (path === "projects/save" && method === "POST") {
      ...
      const activeStatus = isActive !== void 0 ? isActive : true;
      try {
...
// .wrangler/tmp/pages-0eDdtk/oto8qmunar.js
...
// .wrangler/tmp/bundle-DiiukU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DiiukU/middleware-loader.entry.ts
